...
<head>
<meta charset="UTF-8" />
<title>Final Level Games About us – Miki Nagai</title>
    	...
    	<div class="container">
        	<div class="row">
            	<div class="twelvecol">
					...
					<p class="aboutus-content">Rafael Mendoza - Team Leader, SEO, Implementation and Quality Control <br />Melissa McDermott - Site Search/Responsive Design <br />Ashley Pajak - Business Policies, Database & Media Serving <br />Miki Nagai - Admin Controls, Log in System, Web Site Design <br />James Marquis - Transaction System, Use Cases. </p>
                </div>
            </div>
        </div>
    </div>
