        	...
        	<div class="row">
            	<div class="threecol">
                	<ul class="client-menu">
                    	<li><span><image src="image/equals.png" alt="user" /></span><a href="#">Overview</a></li>
                        <li><span><image src="image/user.png" alt="user" /></span><a href="#">My Account</a></li>
                        <li><span><image src="image/book.png" alt="user" /></span><a href="#">My Orders</a></li>
                        <li><span><image src="image/business-card.png" alt="user" /></span><a href="#">Payment Info</a></li>
                        <li><span><image src="image/edit.png" alt="user" /></span><a href="#">Wish List</a></li>
                    </ul>
                </div><!--threecol-->
